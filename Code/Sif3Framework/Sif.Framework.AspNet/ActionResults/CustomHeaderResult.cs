...
namespace Sif.Framework.AspNet.ActionResults
{
    ...
    public class CustomHeaderResult : IHttpActionResult
    {
        ...
        private readonly ICollection<string> _headerValues;
        ...
        public CustomHeaderResult(IHttpActionResult actionResult, string headerName, ICollection<string> headerValues)
        {
            if (string.IsNullOrWhiteSpace(headerName))
                throw new ArgumentException("Header name cannot be null, empty or blank.", nameof(headerName));

            if (headerValues == null || headerValues.Count == 0)
                throw new ArgumentException("Header values cannot be null or empty.", nameof(headerValues));
        ...
        public async Task<HttpResponseMessage> ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            response.Headers.Add(_headerName, _headerValues);
