...
namespace Sif.Framework.AspNet.ControllerSelectors
{
    /// <summary>
    ...
    {
        /// <inheritdoc cref="DefaultHttpControllerSelector(HttpConfiguration)" />
        public ServiceProviderHttpControllerSelector(HttpConfiguration config) : base(config)
        {
        }
        ...
        public override string GetControllerName(HttpRequestMessage request)
        {
            ...
            if (controllerName != null)
            {
                parsedControllerName =
                    Regex.Match(controllerName, SegmentPrefixConstraint.ControllerNamePattern).Groups[1].Value;
            }
