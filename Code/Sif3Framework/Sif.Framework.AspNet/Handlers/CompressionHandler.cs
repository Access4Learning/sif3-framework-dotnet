...
namespace Sif.Framework.AspNet.Handlers
{
    ...
    public class CompressionHandler : DelegatingHandler
    {
        ...
        /// <summary>
        /// Create an instance of this handler based on the deflate and gzip compressors.
        /// </summary>
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (request.Content.Headers.ContentEncoding != null && request.Content.Headers.ContentEncoding.Any())
            {
                ...
                {
                    ICompressor compressor = compressors.SingleOrDefault(
            ...
            if (request.Headers.AcceptEncoding != null && request.Headers.AcceptEncoding.Any())
            {
                ...
                {
                    ICompressor compressor = compressors.FirstOrDefault(
