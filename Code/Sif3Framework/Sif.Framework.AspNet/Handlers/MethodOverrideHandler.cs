...
namespace Sif.Framework.AspNet.Handlers
{
    ...
    {
        private readonly string[] _overrideHeaders = { "methodOverride", "X-HTTP-Method-Override" };
        ...
        {
            string overrideHeader = _overrideHeaders.FirstOrDefault(header => request.Headers.Contains(header));
