...
namespace Sif.Framework.AspNet.MediaTypeFormatters
{
    /// <summary>
    /// XML-based MediaTypeFormatter that serialises an object to XML and then JSON, and de-serialises JSON to XML and
    /// then an object.
    /// </summary>
                ...
                if (!string.IsNullOrWhiteSpace(json))
                {
                    ...
                    if (xmlDocument != null)
                    {
                        using (XmlReader xmlReader = new XmlNodeReader(xmlDocument))
                        {
                            ...
                            var xmlSerializer = (XmlSerializer)GetDeserializer(type, content);
            ...
            TransportContext transportContext)
        {
            ...
            using (var stringWriter = new StringWriter())
            {
                using (var xmlWriter = XmlWriter.Create(stringWriter))
                {
                    ...
                    var xmlSerialiser = (XmlSerializer)GetSerializer(type, value, content);
            ...
            xElement
                ...
                .Where(x =>
                    ...
                    x.Attributes().Any(y => y.Name.LocalName == "nil" && y.Value == "true"))
                .Remove();
