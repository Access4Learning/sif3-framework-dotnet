...
namespace Sif.Framework.AspNet.ModelBinders
{
    ...
    public class MatrixParameterAttribute : ModelBinderAttribute
    {
        ...
        /// Initializes a new instance of this class.
        /// </summary>
        /// <param name="segment"> Can be empty, a target prefix value, or a general route name embedded in "{" and "}". </param>
        /// <example>
        /// <c>[MatrixParam("")] string[] color</c> will match all color values from the whole path.
        ...
        /// <inheritdoc cref="ModelBinderAttribute.GetBinding(HttpParameterDescriptor)" />
        public override HttpParameterBinding GetBinding(HttpParameterDescriptor parameter)
        {
            ...
            return new ModelBinderParameterBinding(
                parameter,
                new MatrixParameterModelBinder(Segment),
