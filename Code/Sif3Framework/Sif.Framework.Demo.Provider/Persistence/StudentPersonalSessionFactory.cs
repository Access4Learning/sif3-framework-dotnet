        ...
        public static StudentPersonalSessionFactory Instance
        {
            ...
            get
            {
                ...
                if (studentPersonalSessionFactory == null)
                {
                    ...
                    studentPersonalSessionFactory.SessionFactory = new Configuration().Configure(HttpContext.Current.Server.MapPath("~/StudentPersonal.cfg.xml")).BuildSessionFactory();
                }
