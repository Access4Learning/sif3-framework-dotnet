...
namespace Sif.Framework.Models.Exceptions
{
    ...
    {
        /// <inheritdoc />
        public InvalidAuthorisationTokenException() : base("The authorisation token is not recognised or is invalid.")
        {
        }

        /// <inheritdoc />
        public InvalidAuthorisationTokenException(string message) : base(message)
        {
        }
