...
namespace Sif.Framework.Services.Sessions
{
    ...
    public class SessionService : ISessionService
    {
        ...
        /// <returns>The matched session entry if exists; null otherwise.</returns>
        ...
        /// <param name="userToken">User token.</param>
        /// <param name="instanceId">Instance ID.</param>
        /// <returns>Value of the property for the matched session entry if exists; null otherwise.</returns>
            ...
            string instanceId = null)
        {
            ...
            try
            {
                return sessionValues.SingleOrDefault();
            }
            catch (InvalidOperationException e)
            {
                throw new DuplicateFoundException(
