...
namespace Sif.Framework.Demo.Uk.Provider.Actions
{
    class DefaultActions : BasicPhaseActions
    {
        ...
        {
            job.changeState(JobStateType.INPROGRESS, "CREATE to " + phase.Name);
        ...
        {
            job.changeState(JobStateType.INPROGRESS, "RETRIEVE to " + phase.Name);
        ...
        {
            job.changeState(JobStateType.INPROGRESS, "DELETE to " + phase.Name);
