    ...
    create table ENVIRONMENT_INFRASTRUCTURE_SERVICES (
       ...
       constraint FKB343704D84903B70 foreign key (INFRASTRUCTURE_SERVICE_ID) references INFRASTRUCTURE_SERVICE,
    ...
    create table ENVIRONMENT_REGISTER (
       ...
       USER_TOKEN TEXT,
       ZONE_ID BIGINT,
       constraint FK47B71BA2D1CA0358 foreign key (ZONE_ID) references ZONE
    )
    ...
    create table ENVIRONMENT_REGISTER_INFRASTRUCTURE_SERVICES (
       ...
       constraint FK86CD31CA84903B70 foreign key (INFRASTRUCTURE_SERVICE_ID) references INFRASTRUCTURE_SERVICE,
    ...
    create table INFRASTRUCTURE_SERVICE (
        INFRASTRUCTURE_SERVICE_ID  integer primary key autoincrement,
       NAME INT,
       VALUE TEXT
    )
